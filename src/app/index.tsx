...
export default function WelcomeScreen() {
  const { profile, partner, loading, setupCouple, joinCouple, rejoinCouple, cancelCouple, clearProfile } = useProfile()
  ...
  if (profile && !partner && step === 'choice') {
    ...
    return (
      <View style={styles.container}>
        ...
        <Pressable onPress={() => { cancelCouple(); setStep('choice') }} style={styles.backButton}>
